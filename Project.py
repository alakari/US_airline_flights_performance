...
#############################################################
#
#  In this Assignment, we demonstrate the data visualization#
#  skills you learned by completing this course.            #
#   Dashboard is based on the concept of demonstrating US   #
#  Domestic Airline Flights Performance and Yearly average  #
#  flight delay statistics for a given year ( 2005 to 2020).#
#############################################################
#
...
# List of years (creating List of years required for Dash)
